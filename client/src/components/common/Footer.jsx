    ...
    <>
      <footer>
        <div className="w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer">
          ...
          <div className="w-[65%] flex sm:flex-row flex-col sm:justify-between sm:items-start my-4">
          ...
          <div className="sm:w-[65%] w-full h-[0.25px] bg-gray-400 mt-5" />

          <div className="sm:w-[65%] w-full flex justify-between items-center mt-3">
